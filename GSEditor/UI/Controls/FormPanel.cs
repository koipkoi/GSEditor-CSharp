...
public sealed class FormPanel : Panel
{
  ...
  public static readonly DependencyProperty ColumnSpacingProperty = DependencyProperty.Register("ColumnSpacing", typeof(double), typeof(FormPanel), new FrameworkPropertyMetadata(15.0, FrameworkPropertyMetadataOptions.AffectsMeasure));
  ...
  public static readonly DependencyProperty RowSpacingProperty = DependencyProperty.Register("RowSpacing", typeof(double), typeof(FormPanel), new FrameworkPropertyMetadata(10.0, FrameworkPropertyMetadataOptions.AffectsMeasure));
  ...
  public static readonly DependencyProperty LabelControlSpacingProperty = DependencyProperty.Register("LabelControlSpacing", typeof(double), typeof(FormPanel), new FrameworkPropertyMetadata(5.0, FrameworkPropertyMetadataOptions.AffectsMeasure));
  ...
  protected override Size MeasureOverride(Size availableSize)
  {
    ...
    if (Coordinator != null && (newLabelSize != oldLabelSize || newControlSize != oldControlSize))
      Coordinator.ControlOrLabelSizeChanged(this);

    var itemCount = Children.Count / 2;
    var rows = (itemCount / Columns) + (itemCount % Columns == 0 ? 0 : 1);
    return new Size(
  ...
  protected override Size ArrangeOverride(Size finalSize)
  {
    ...
    var itemCount = Children.Count / 2;
    var rows = (itemCount / Columns) + (itemCount % Columns == 0 ? 0 : 1);
    return new Size(finalSize.Width, rowHeight * (rows + 1));
  }
}
